...
#  - QTANNER_CMD: full command string, e.g. QTANNER_CMD="python src/qtanner/search.py"
#  - QTANNER_MODULE: python module for -m, e.g. QTANNER_MODULE="qtanner.search"
...
if spec is None:
    ...
    print("  - Or install editable: python -m pip install -e .")
    sys.exit(2)
PY
