...
## Monitor progress
OUT="results/c2xc2xc2_d16_20260121_042823"
while true; do
  clear
  date
...
ID="PUT_CODE_ID_HERE"
python -m qtanner.check_distance --run "${OUT}" --id "${ID}" --steps 20000 --dist-m4ri-cmd dist_m4ri --target-distance 16
